  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
                  ...
                  <form id = "click" action= "<?php htmlspecialchars($_SERVER["PHP_SELF"])?>" method = "POST">
                    ...
                    <div class="u-container-style u-list-item u-repeater-item">
                      <div class="u-container-layout u-similar-container u-container-layout-5">
                        ...
                        <div class="u-shape u-shape-rectangle u-shape-2"><input type="text" name="description" placeholder="Description" value="<?php echo $row['Income_Description']; ?>"></div>
                      </div>
                    </div>
                    ...
                    <div class="u-container-style u-list-item u-repeater-item">
                      <div class="u-container-layout u-similar-container u-container-layout-6">
                        ...
                        <div class="u-shape u-shape-rectangle u-shape-3"><input type="text" name="from" placeholder="From" value="<?php echo $row['Income_From']; ?>"></div>
                      </div>
                    </div>
                    ...
                    <div class="u-container-style u-list-item u-repeater-item">
                      <div class="u-container-layout u-similar-container u-container-layout-7">
                        ...
                        <div class="u-shape u-shape-rectangle u-shape-4"><input type="text" name="amount" placeholder="Amount" value="<?php echo $row['Income_Amount']; ?>"></div>
                      </div>
                    </div>
                    ...
                    <div class="u-container-style u-list-item u-repeater-item">
                      <div class="u-container-layout u-similar-container u-container-layout-8">
                        ...
                        <div class="u-shape u-shape-rectangle u-shape-5"><input type="date" name="date" placeholder="Date" value="<?php echo $row['Income_Date']; ?>"></div>
                      </div>
                    </div>
    ...
    <?php
        if(isset($_POST['update'])){
            ...
            $sql = "UPDATE income SET Income_Type='$type',
            Income_Amount='$amount',Income_Date='$date',Income_From='$from',Income_Description='$description' WHERE Income_id =  $income_id";

            if( mysqli_query($conn, $sql)){
                echo '<script>alert("Cash Receipt has been updated")</script>';
