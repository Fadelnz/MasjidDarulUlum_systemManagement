...
<link rel="stylesheet" href="Ahli-Kariah-Form-ver2.css" media="screen">
    ...
    <meta property="og:title" content="Carta-Organisasi">
          ...
          <div class="u-clearfix u-sheet u-sheet-2">
            <div class="u-expanded-width u-layout-horizontal u-list u-list-1">
              <div class="u-repeater u-repeater-1">
                ...
                <div class="u-container-align-center u-container-style u-list-item u-repeater-item" data-href="index.html#carousel_36a6">
                ...
                <div class="u-container-align-center u-container-style u-list-item u-repeater-item">
                  <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-5">
                    <a href="Ahli-kariah-Application-Form.php" class="u-align-center u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-style u-custom-font u-font-roboto-condensed u-none u-text-black u-btn-6">AHLI KARIAH</a>
                  </div>
                </div>
              </div>
...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
    ...
    <section class="u-clearfix u-grey-10 u-section-1" id="sec-dd5d">
        <p class="u-custom-font u-font-roboto-condensed u-text u-text-default u-text-1">Borang Ahli Kariah</p>
        <div class="ahli-kariah-form-container">
                <form id = "click" action= "<?php htmlspecialchars($_SERVER["PHP_SELF"])?>" method = "POST">
                    <p class="name-label">Nama</p>
                    <span>Umur</span>
                    <input type="text" name="name" placeholder="Enter Valid Name">
                    <input type="text" name="age" placeholder="Enter Valid Age">
                    <p class="marital-label">Status</p>
                    <span>Agama</span>
                    <select name="marital">
                    ...
                    <select name="religion">
                        ...
                        <option value="christianity">Kristian</option>
                        <option value="buddhism">Buddha</option>
                        <option value="other">Lain-lain</option>
                    </select>
                    <p class="email-label">E-mel</p>
                    <span>Nombor Telefon</span>
                    <input type="text" name="email" placeholder="Enter Valid Email">
                    <input type="text" name="phone" placeholder="Enter Valid Phone Number">
                    <p class="email-label">Alamat Penuh</p>
                    <input type="text" name="address" placeholder="1st Row Address">
                    <input type="text" name="address-2" placeholder="2nd Row Address"><br>
                    <button type="submit" name="submit-form" form="click">Hantar</button>
                </form>
                ...
                if(isset($_POST['submit-form'])){
                    ...
                    VALUES ('$name','$status','$age','$religion','$marital','$address','$phonenumber','$email','$date')";
                    ...
                    if( mysqli_query($conn, $sql)){
                      ...
                      $subject = "Permohonan Ahli Kariah";
                      mail('hotsunmeequee@gmail.com',$subject,$msg);
                      echo '<script>alert("Permohonan anda diterima, sila tunggu sementara kami menyemak dan memproses borang anda, terima kasih!")</script>';
