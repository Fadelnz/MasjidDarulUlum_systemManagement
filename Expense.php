  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
                  ...
                  <form id = "click" action= "<?php htmlspecialchars($_SERVER["PHP_SELF"])?>" method = "POST">
                    ...
                    <div class="u-container-style u-list-item u-repeater-item">
                      <div class="u-container-layout u-similar-container u-container-layout-6">
                        ...
                        <div class="u-shape u-shape-rectangle u-shape-3"><input type="text" name="paid-to" placeholder="Paid to" ></div>
                      </div>
                    </div>
    ...
    <?php
        if(isset($_POST['add'])){
            ...
            $sql = "INSERT INTO expense(Expense_Type, Expense_Amount, Expense_Date, Expense_status, Expense_To, Expense_Description) VALUES ('$type', '$amount', '$date', '$status', '$to', '$description')";

            if( mysqli_query($conn, $sql)){
                $msg = "Pending Cash Voucher\n";
                $msg .="Transaction details\n=============\n";
                $msg .="Expense Type: $type\nAmount: $amount";
                $msg .="Description: $description\nDate: $date\nStatus: $status";
                $subject = "New Cash Voucher";
                mail('hotsunmeequee@gmail.com',$subject,$msg);
                echo '<script>alert("Cash Voucher has been sent, you will be notified when the cash voucher is accepted")</script>';
            }else{
